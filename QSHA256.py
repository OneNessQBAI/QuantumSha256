...
def quantum_sha256(message):
    ...
    # Print results
    print(f"Quantum result (binary): {quantum_result}")
    print(f"Measured qubits: {classical_bits}")
    print(f"Quantum SHA-256 (hex): {hex_result}")

def main():
    # Ask for user input
    message = input("Enter a message to hash using Quantum SHA-256: ")
    quantum_sha256(message)
